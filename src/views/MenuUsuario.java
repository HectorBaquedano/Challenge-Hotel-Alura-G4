...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    String textoDescripcion = "<html><body>Sistema de reserva de hotel.<br> Controle y administre de forma óptima y fácil el flujo de reservas y de huespédes del hotel   </body></html>";
