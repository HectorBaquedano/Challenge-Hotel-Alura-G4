...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		lblCheckIn.setBounds(68, 130, 169, 14);
		...
		lblTitulo.setBounds(99, 60, 239, 42);
		...
		lblValor.setBounds(70, 303, 215, 14);
		...
		txtValor.setBounds(80, 328, 277, 33);
	...
	//metodo creado para guardar los datos de la view
	...
	public void calcularValor(JDateChooser fechaE, JDateChooser fechaS) {
		if(fechaE.getDate() != null && fechaS.getDate() != null) {
			...
			int dias = -1;
			int noche = 500; // valor aproximado en lempiras del precio diario $20
			int valor;
